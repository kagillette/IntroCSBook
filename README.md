...
This is my attempt to learn the pretext scripting language and produce a chapter for an introductory CS programming class as a demo. My final goal is to host it on Runestone Academy and add to it.
